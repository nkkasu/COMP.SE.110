...
public enum SituationTypeV1 {
  ...
  @JsonCreator
  public static SituationTypeV1 fromValue(String value) {
    for (SituationTypeV1 b : SituationTypeV1.values()) {
