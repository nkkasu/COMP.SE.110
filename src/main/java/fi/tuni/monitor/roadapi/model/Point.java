...
public class Point extends GeometryObject {
  ...
  **/
  ...
  public Point coordinates(List<Object> coordinates) {
  ...
  @ApiModelProperty(example = "[26.97677492,65.3467385]", required = true, value = "An array of coordinates. Coordinates are in WGS84 format in decimal degrees: [LONGITUDE, LATITUDE, {ALTITUDE}]. Altitude is optional and measured in meters.")
