...
public class MultiLineString extends GeometryObject {
  ...
  **/
  ...
  @ApiModelProperty(example = "MultiLineString", required = true, value = "")
  ...
  public MultiLineString coordinates(List<Object> coordinates) {
    
    this.coordinates = coordinates;
    return this;
  }

  public MultiLineString addCoordinatesItem(List<List<Double>> coordinatesItem) {
  ...
  @ApiModelProperty(example = "[[[100,0],[101,1]],[[102,2],[103,3]]]", required = true, value = "An array of LineString coordinates. Coordinates are in WGS84 format in decimal degrees: [LONGITUDE, LATITUDE, {ALTITUDE}]. Altitude is optional and measured in meters.")
